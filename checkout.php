...
<section class="py-5">
    <div class="container">
        <div class="card rounded-0">
            ...
            <h3 class="text-center"><b>Apartar Producto</b></h3>
                ...
                <div class="row row-col-1 justify-content-center">
                    <div class="col-6">
                        <div class="form-group col address-holder">
                            <label for="" class="control-label">Dirección de Habitacion</label>
                        ...
                        <hr>
                        <div class="col my-3">
                        <h4 class="text-muted">Apartar Producto</h4>
                            <div class="d-flex w-100 justify-content-between">
                                <button class="btn btn-flat btn-dark">Aceptar</button>
