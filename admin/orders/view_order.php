...
<div class="card card-outline card-primary">
    <div class="card-body">
        <div class="conitaner-fluid">
            ...
            <p><b>Dirección: <?php echo $delivery_address ?></b></p>
            ...
            <div class="col-6 row row-cols-2">
                ...
                <?php 
                    switch($status){
	                    ...
	                    break;
                        case '2':
                            echo '<span class="badge badge-warning px-3 rounded-pill">Apartado</span>';
	                    break;
                        case '3':
                            echo '<span class="badge badge-success px-3 rounded-pill">Entregado</span>';
	                    break;
                        default:
